...
while it is running. A session can then be stopped to
...
that instance, we only need to start two live sessions
...
<p>
Also, any logs that are sent to the server while no session
